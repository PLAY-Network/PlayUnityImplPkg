...
{
    private const string PackagesFolderPath = "Packages/io.getready.rgn.impl.firebase";
    private const string DestinationLinkPath = "Assets/ReadyGamesNetwork/Linker/RGNImplFirebase";
